# Stage 01 — Python & Software Design

> Python is the language of AI. But knowing syntax isn't enough —
> you need to write code that doesn't fall apart when your project grows.
> These two resources cover both.
...
*Next → [Stage 02: Math Foundations](../stage-02-math/)*
