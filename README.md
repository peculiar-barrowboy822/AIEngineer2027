...
6. If Windows shows a security prompt, choose Run anyway only if you downloaded it from the release page above.
7. Keep the app in a folder you can find again, such as Downloads or Desktop.
...
7. If the app asks for access to files or the network, allow it only if you want those features to work.
